...
class WZMLStyle:
    ...
    ST_BN1_NAME = 'Group'
    ST_BN1_URL = 'https://t.me/+nRv7R3RukAw2MWU1'
    ST_BN2_NAME = 'Updates ⚡'
    ST_BN2_URL = 'https://t.me/thunder_developer'
    ST_MSG = '''<i>This bot can mirror all your links|files|torrents to Google Drive or any rclone cloud or to telegram or to ddl servers.</i>
<b>Type {help_command} to get a list of available commands @thunder_developer</b>'''
    ST_BOTPM = '''<i>Now, This bot will send all your files and links here. Start Using ...</i>'''
    ST_UNAUTH = '''<i>You Are not authorized user! Please use in group</i>'''
